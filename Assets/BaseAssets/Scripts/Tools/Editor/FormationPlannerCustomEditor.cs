...
{
    [CustomEditor(typeof(FormationPlanner))]
    [CanEditMultipleObjects]
    public class FormationPlannerCustomEditor : Editor
    {
        private void SetFieldCondition()
        {
            ShowOnEnum("formationType", "Regular", "isMirrored");
            ShowOnEnum("formationType", "Regular", "isRightAligned");
            ShowOnEnum("formationType", "Regular", "rowDistance");
            ShowOnEnum("formationType", "Regular", "columnDistance");
            ShowOnEnum("formationType", "Regular", "tilt");
            ShowOnEnum("formationType", "Regular", "troopFormation");

            ShowOnEnum("formationType", "Line", "isLoop");
            ShowOnEnum("formationType", "Line", "lineSize");
            ShowOnEnum("formationType", "Line", "lineCorners");

            ShowOnEnum("formationType", "Manual", "manualPositions");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (obj.NextVisible(true))
            {
                ...
                FormationPlanner _target = target as FormationPlanner;
                _target.DrawButtons();
            }
