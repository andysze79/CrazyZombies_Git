...
namespace BaseAssets.Tools.InternalEditor
{
    ...
    public class SpawnManagerCustomEditor : Editor
    {
        ...
        {
            ShowOnEnum("spawnType", "SpawnInBurst", "burstCount");
            ShowOnEnum("spawnType", "SpawnInBurst", "burstDelay");
            ShowOnEnum("spawnType", "SpawnInBurst", "burstSpawnDelayInitial");
            ...
            ShowOnEnum("spawnType", "SpawnEndless", "endlessDestroyTime");
            ShowOnEnum("spawnType", "SpawnEndless", "endlessTargetAreaDimensions");
            ShowOnEnum("spawnType", "SpawnEndless", "endlessTargetAreaPosition");
            ShowOnEnum("spawnType", "SpawnEndless", "endlessTargetAxis");

            ShowOnEnum("spawnLocationType", "SpecificLocations", "spawnLocations");

            ShowOnEnum("spawnLocationType", "RandomArea", "spawnAreaDimensions");
            ShowOnEnum("spawnLocationType", "RandomArea", "spawnAreaPosition");

            ShowOnEnum("targetingType", "BoxCast", "targetAreaDimension");
            ShowOnEnum("targetingType", "BoxCast", "targetAreaPosition");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            SpawnManager _target = target as SpawnManager;
            _target.DrawButtons();
